...
```
```{r heatmap_function}
BoeckRNA_ELT2_chip_Heatmap <- function(subsetrows, label) {
...
BoeckRNA_ELT2_chip_Heatmap(real & changing & embryo_specific, "Log(RNA Timecourse), No threshold on variance")
