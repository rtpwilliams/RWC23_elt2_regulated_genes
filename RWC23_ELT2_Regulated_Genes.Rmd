...
# pdf("./03_plots/200527_elt2elt7DERNAseq_L1elt2bound_heatmap.pdf", height = 5, width = 5)
# Ha_L1chip
# dev.off()
```
...
# ggsave(
#   "./03_plots/200527_percentage_l1bound_per_expression_cluster.pdf",
#   width = 4,
#   height = 5
# )
```
...
# Fish out the genes that change the most
...
```{r}
variance_per_gene %>% filter(set == "SET2") %>% arrange(desc(variance))
```
