...
dim(all_pairwise_subset_Zscore)
pheatmap(all_pairwise_subset_Zscore, 
         ...
         width = 6,
         height = 6,
         file = "./03_plots/200411_All_DE_Genes_Elt2_Elt7_rowZscore_Bound_Expressed_Annotation.pdf")
...
pheatmap(all_pairwise_subset_Zscore, 
         ...
         width = 6,
         height = 9,
         filename = "./03_plots/200410_Any_DE_Genes_ELT2_ELT7_rowZscore_bound_expressed_class_annotation_full_assignment.pdf")

rownames(bound_expressed_class_annotation) %in% rownames(all_pairwise_subset_Zscore) %>% unique
```

Extract clusters.  

```{r}
out <- pheatmap(all_pairwise_subset_Zscore, 
         annotation_row = bound_expressed_class_annotation,
         annotation_colors = bound_expressed_ann_colors,
           cluster_cols = FALSE, 
           cluster_rows = TRUE, 
