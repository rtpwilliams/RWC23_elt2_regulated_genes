...
```{r}
elt2_peaks <- read_excel("./01_input/2020_03_27_peaks.xlsx")
...
```{r gene-rowname}
rowNormGeneNameMatrix <- id2name(rownormMatrix)

head(rowNormGeneNameMatrix)
```

Now plot a heatmap of ELT-2 regulated genes.  

```{r plot-elt2-regulated-heatmap}
pheatmap(rowNormGeneNameMatrix, 
         cluster_cols = FALSE, 
         cluster_rows = TRUE, 
         show_rownames = TRUE, 
         border_color = NA,
         cellheight = 10,
         filename = "./03_plots/200327_L1_Elt2_Bound_Regulated_Genes_Row_Normalized.pdf")
...
pheatmap(elt2_bound_TF_rowNorm_matrix, 
         ...
         border_color = NA,
         cellheight = 10,
         filename = "./03_plots/200328_L1_Elt2_Bound_Regulated_TFs_Row_Normalized_Heatmap.pdf")
```
