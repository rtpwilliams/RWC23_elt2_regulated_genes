...
pheatmap(elt2_bound_TF_rowNorm_matrix, 
         ...
         border_color = NA,
         cellheight = 10,
         filename = "./200328_L1_Elt2_Bound_Regulated_TFs_Row_Normalized_Heatmap.pdf")
```
...
pheatmap(elt2_bound_TF_zscore_matrix, 
         ...
         border_color = NA,
         cellheight = 10,
         filename = "./200328_L1_Elt2_Bound_Regulated_TFs_Zscore_Heatmap.pdf")
```
...
pheatmap(elt2bound_zscore_matrix, 
         ...
         border_color = NA,
         cellheight = 10,
         filename = "./200327_L1_Elt2_Bound_Regulated_Genes_Zscore_Heatmap.pdf")
```
