...
dimnames(tableformosaic) <- list("dinneners" = paste("SET", 1:6, sep = ""), " " = c("Embryo_Specific","Increasing","L3_High","Larval","not bound","Not_Changing"))
...
class(chisq.test(tableformosaic)$residuals)
```

```{r}
chisq.test(tableformosaic)$residuals
```
...
dineen_ELT2_pearson_residuals$ELT2_cluster <- factor(dineen_ELT2_pearson_residuals$ELT2_cluster, levels = c("Embryo_Specific", "Larval", "Increasing", "L3_High", "Not_Changing", "not bound"))
