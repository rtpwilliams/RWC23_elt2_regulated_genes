...
# pdf("./03_plots/01a_DE_Heatmap_elt2elt7DERNAseq_L1elt2bound_200615.pdf", height = 4, width = 4.5)
# Ha_L1chip
# dev.off()
```
...
# pdf("./03_plots/01b_DE_Heatmap_elt2elt7DERNAseq_L1elt2bound_spencerRNA_200913.pdf", height = 6.5, width = 6)
# Ha_L1chip_spencer
# dev.off()
```
...
# ggsave("./03_plots/02_proportion_of_l1elt2_per_expression_cluster_200428.pdf", height = 2, width = 5)
```
...
# ggsave("./03_plots/03_number_of_l1elt2_per_expression_cluster_200428.pdf", height = 2, width = 5)
```
...
# ggsave(
#   "./03_plots/04_percentage_l1bound_per_expression_cluster_200615.pdf",
#   width = 4,
#   height = 5
# )
```
...
# The code below sometimes throws an error
# if so: print plot in console, then use Export>As PDF to save
# pdf("./03_plots/05a_DE_Heatmap_L1elt2bound_elt2bindclusters_anno_200615.pdf", height = 6.5, width = 6)
# Ha_L1chip_clusterchip
# dev.off()
```
...
# pdf("./03_plots/05b_DE_Heatmap_L1elt2bound_elt2bindclusters_spencerRNA_anno_200913.pdf", height = 6.5, width = 8)
# Ha_L1chip_clusterchip_spencerRNA
# dev.off()
```
...
# ggsave("./03_plots/07_Set_percent_present_per_Cluster_200615.pdf")
```
...
# ggsave(filename = "./03_plots/08_Percent_of_ELT2bindClust_per_ExpressionClust_200615.pdf",
#        height = 5,
#        width = 7)
```
...
# pdf("./03_plots/09a_DE_Heatmap_L1elt2boundOnly_200913.pdf", height = 6.5, width = 6)
# Ha_bound_only
# dev.off()
```
...
# pdf("./03_plots/09b_DE_Heatmap_L1elt2boundOnly_elt2bindclusters_anno_200913.pdf", height = 6.5, width = 6)
# Ha_bound_only_chipClust
# dev.off()
```
...
# pdf("./03_plots/09c_DE_Heatmap_L1elt2boundOnly_elt2bindclusters_anno_200913.pdf", height = 6.5, width = 6)
# Ha_bound_only_chipClust_spencer
# dev.off()
```
...
# ggsave("./03_plots/10a_Bound_Only_Cluster_percent_present_per_Set_200913.pdf")
```
...
# ggsave("./03_plots/10b_Bound_Only_Set_percent_present_per_Cluster_200913.pdf")
```
...
```{r}
ggplot(bound_only_expression_binding_stats,
       aes(x = set,
           y = percent, fill = ELT2_cluster)) +
  geom_bar(stat = "identity") +
  ...
  theme_classic() +
  geom_hline(
    data = bound_only_percent_bound_per_ELT2_cluster,
    color = "red",
    linetype = "dashed",
    aes(yintercept = percent)
  ) +
...
# ggsave(filename = "./03_plots/11_Bound_Only_Percent_of_ELT2bindClust_per_ExpressionClust_200615.pdf",
#        height = 5,
#        width = 8)
```
...
# pdf("./03_plots/12_Differential_Expression_of_All_TFs.pdf", height = 20, width = 4)
# tf_heatmap
# dev.off()
```
...
# pdf("./03_plots/13b_Differential_Expression_of_All_TFs_L1elt2bound_anno.pdf", height = 5, width = 5.5)
# tf_heatmap_L1bound_spencerRNA
# dev.off()
```
...
# pdf("./03_plots/14a_Differential_Expression_of_All_TFs_L1elt2bound_split.pdf", height = 5, width = 5.5)
# tf_heatmap_L1bound_split
# dev.off()
```
...
# pdf("./03_plots/14b_Differential_Expression_of_All_TFs_L1elt2bound_split_spencerRNA.pdf", height = 5, width = 5.5)
# tf_heatmap_L1bound_split_spencerRNA
# dev.off()
```
...
# pdf("./03_plots/15a_Differential_Expression_Bound_TFs_only.pdf", height = 5, width = 5.5)
# HAboundTF
# dev.off()
...
# pdf("./03_plots/15b_Differential_Expression_Bound_TFs_only_spencerRNA.pdf", height = 5, width = 5.5)
# HAboundTF_spencerRNA
# dev.off()
```
