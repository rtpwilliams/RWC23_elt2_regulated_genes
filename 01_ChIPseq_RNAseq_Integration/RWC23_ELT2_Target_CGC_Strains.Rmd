...
genes_to_test <- variance_per_gene %>% filter(external_gene_id %in% c("ets-4", "cebp-1", "mtl-2", "pqm-1")) %>% select(wbps_gene_id, external_gene_id)
...
pdf(file = "./03_plots/16_ELT2_DE_Genes_ELT2bound_Test_Genes_Annotated_20-11-10.pdf", width = 5, height = 5)
Ha_bound_only_test_gene
dev.off()
```
